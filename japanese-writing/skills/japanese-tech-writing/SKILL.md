...
読ませる文章（記事、解説、設計ドキュメントの背景・導入、スパイク報告、スライド草稿など、正確さに加えて読み進める推進力が要る文章）を書く/推敲するときは、`../cognitive-rhythm-writing/SKILL.md`（認知リズムの規範）も併用する。この規範で文章の正確さ・論証・演出抑制を担保し、cognitive-rhythm-writing で緩急と推進力を足す。
